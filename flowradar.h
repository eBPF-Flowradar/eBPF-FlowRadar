...
#define FLOW_FILTER_SIZE   245000  //FLOWFILTER_HASH_COUNT*BITS_PER_SLICE
#define COUNTING_TABLE_SIZE 30000   //COUNTING_TABLE_HASH_COUNT*COUNTING_TABLE_ENTRIES_PER_SLICE
#define MAX_PURE_CELLS COUNTING_TABLE_SIZE * 2    //need to check this
