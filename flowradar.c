...
__u128 flow_key_buff [30000];
__u32 flow_count_buff [30000];
__u32 packet_count_buff [30000];
...
static void poll_counting_table(int counting_table_file_descriptor, int poll_interval) {
